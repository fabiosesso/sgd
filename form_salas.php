    ...
    <div class="container" id="tamanhoContainer" style="margin-top: 40px;">
        ...
        <form action="inserirSala.php" method="post" style="margin-top:20px">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nomeSala" name="nomeSala" autocomplete="off" required>
            </div>

            <div class="mb-3">
                <label for="capacidadeSala" class="form-label">Capacidade Sala</label>
                <input type="number" class="form-control" name="capacidadeSala" autocomplete="off" required>
            </div>   
